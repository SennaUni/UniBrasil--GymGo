...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
    ...
    while cap_comp.isOpened():
        ...
        if not exercise_started:
            ...
            # print(similarity_score <= similarity_threshold)
            # print(current_index)
        ...
        cv2.putText(annotated_image_comp, exercise_count_text, (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
        cv2.putText(annotated_image_comp, similarity_text, (10, 70), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
