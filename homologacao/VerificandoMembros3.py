...
# Definir a lista de conexões entre pontos de landmark
...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
    ...
    if ref_landmarks is None:
        ...
        while cap_ref.isOpened():
            ...
            mp_drawing.draw_landmarks(
                annotated_image_ref, results_ref.pose_landmarks, connections)
    ...
    while cap_comp.isOpened():
        ...
        if len(landmarks_comp) != len(ref_landmarks[0]):
            continue
        ...
        for connection in connections:
            ...
            if landmarks_comp[start_index].all() == 0.0 or landmarks_comp[end_index].all() == 0.0:
                all_members_present = False
                missing_members.append(connection)
        ...
        mp_drawing.draw_landmarks(
            annotated_image_comp, results_comp.pose_landmarks, connections)
