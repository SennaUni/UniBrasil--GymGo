...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
    ...
    while cap_comp.isOpened():
        ...
        # Verificar se todos os membros estão presentes na imagem
        num_visible_landmarks = len(results_comp.pose_landmarks.landmark)
        num_expected_landmarks = len(PoseLandmark)
        if num_visible_landmarks < num_expected_landmarks:
            continue
